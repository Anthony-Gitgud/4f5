...
public class Grille implements GrilleLectureSeule {
	...
	public Jeton ajouterJeton(int idColonne, Couleur couleur, ModeJeu modeJeu, Difficulte difficulte) {
		J.appel(this);
		
		return colonnes.get(idColonne).ajouterJeton(couleur, difficulte, modeJeu);
	}
